    ...
    <div className="max-w-2xl">
      <div className="space-y-4">
        <p style={{ fontFamily: "Geist Mono, monospace", lineHeight: "150%" }}>
          Joaquim Breno is a Brazilian computer engineer interested in ideas surrounding machine learning, 
        ...
        <p style={{ fontFamily: "Geist Mono, monospace", lineHeight: "150%" }}>
          In this blog, I share bits of my experiences, from my very first steps in tech to my latest adventures. 
          Hopefully, even the nonsense I write here helps someone with similar interests.
        </p>
      </div>
    </div>
  );
