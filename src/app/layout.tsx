  ...
  return (
    <html lang="pt">
      <head>
        ...
        {/* RSS Feeds */}
        <link rel="alternate" type="application/rss+xml" title="RSS Feed (PT)" href="/pt/rss.xml" />
        <link rel="alternate" type="application/rss+xml" title="RSS Feed (EN)" href="/en/rss.xml" />
      </head>
      <body
